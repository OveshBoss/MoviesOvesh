...
# Bot information
SESSION = environ.get('SESSION', 'OveshVBoss')
...
PICS = (environ.get('PICS', 'https://envs.sh/1Ll.jpg')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1416433622').split()] # For Multiple Id Use One Space Between Each.
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003132923661').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002342243776') # give your force subscribe channel id here else leave it blank
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-4833204360')
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None

# This Channel Is For /batch command file store.
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1003169061900')).split()]  # For Multiple Id Use One Space Between Each.
...
PUBLIC_FILE_CHANNEL = environ.get('PUBLIC_FILE_CHANNEL', 'iwijwimq') # Public Channel Username Without @ or without https://t.me/ and Bot Is Admin With Full Right.


# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+5WgA1gpnspYxOGI1')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/OveshBossOfficial')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'RWyDgI8QVwAwMTVl') # Support Chat Link Without https:// or @
